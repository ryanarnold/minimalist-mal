...
export default [
  {
    ...
    done_airing: false,
    start_date: Timestamp.fromDate(new Date('2022-04-09')),
    end_date: null,
    rank: 13,
    synopsis:
  ...
  },
  {
    ...
    title_jp: 'バッカーノ！',
    done_airing: true,
    start_date: Timestamp.fromDate(new Date('2007-07-27')),
    end_date: Timestamp.fromDate(new Date('2007-11-02')),
    rank: 176,
    synopsis:
  ...
  },
  {
    ...
    done_airing: true,
    start_date: Timestamp.fromDate(new Date('2022-04-09')),
    end_date: Timestamp.fromDate(new Date('2022-04-09')),
    rank: 647,
    synopsis:
  ...
  },
  {
    ...
    title_jp: '秒速５センチメートル',
    done_airing: true,
    start_date: Timestamp.fromDate(new Date('2007-03-03')),
    end_date: Timestamp.fromDate(new Date('2007-03-03')),
    rank: 1317,
    synopsis:
  ...
  },
  {
    ...
    title_jp: 'CLANNAD',
    done_airing: true,
    start_date: Timestamp.fromDate(new Date('2007-10-05')),
    end_date: Timestamp.fromDate(new Date('2008-03-28')),
    rank: 552,
    synopsis:
  ...
  },
  {
    ...
    done_airing: true,
    start_date: Timestamp.fromDate(new Date('2008-10-03')),
    end_date: Timestamp.fromDate(new Date('2009-03-27')),
    rank: 18,
    synopsis:
